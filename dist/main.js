...
class Todo {
  ...
  formatDate() {
    return (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.dueDate), 'dd/MM/yyyy');
  }
}
...
categoryForm.addEventListener('submit', (event) => {
  ...
  } else if (formValue.title.value === '') {
    // Cancel the form
    categoryForm.style.display = 'none';
  } else if (categories.some((cat) => cat.edit === true)) {
    // Check if category exists and needs editing
