...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n    min-height: 100vh;\n    margin: 0;\n}\n\nbody {\n    display: flex;\n    flex-direction: row;\n    min-height: 100vh;\n    margin: 0;\n}\n\n.sidebar {\n    padding: 20px 0 0 5px;\n    width: 10%;\n    min-width: 120px;\n}\n\nh1 {\n    text-align: center;\n    margin-top: 0;\n    padding-right: 5px;\n}\n\nh2, h3, h4, h5 {\n    margin: 0;\n}\n\n.panel {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    min-height: 90%;\n}\n\n#addCategory {\n    margin-top: 20px;\n    float: right;\n}\n\n#categories {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n    gap: 20px;\n}\n\n#categoryForm {\n    margin-top: 20px;\n    text-align: right;\n}\n\n#categoryForm > input {\n    width: 50%;\n}\n\n.category {\n    border: 2px solid rgb(138, 138, 194);\n    padding: 10px;\n    border-top-left-radius: 10px;\n    border-bottom-left-radius: 10px;\n}\n\n#main {\n    width: 100%;\n    background-color: rgb(243, 243, 243);\n    display: flex;\n    flex-direction: column;    \n    align-items: center;\n}\n\n.listTitle {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-around;\n    padding: 20px;\n    width: 100%;\n}\n\n#list {\n    width: 100%;\n}\n\n.todo {\n    padding: 5px;\n    margin: 15px;\n    border: 1px solid rgb(138, 138, 194);\n    background-color: white;\n    border-radius: 10px;\n    box-shadow: 0 3px 3px rgb(138, 138, 194);\n}\n\n.todoHead {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n}\n\n.expanded {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.expandButtons {\n    display: flex;\n    gap: 10px;\n    margin-left: 20px;\n}\n\n.edit, .delete {\n    border-radius: 5px;\n}\n\n#addTodo, #addCategory  {\n    font-size: x-large;\n}\n#addTodo:hover, #addCategory:hover  {\n    background-color: rgb(98, 146, 98);\n}\n\n#addCategory {\n    border-top-left-radius: 10px;\n    border-bottom-left-radius: 10px;\n}\n\n#addTodo {\n    border-radius: 15px;\n    padding: 0 10px 0 10px;\n}\n\n#todoForm {\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    gap: 10px;\n    padding: 10px;\n    width: 60%;\n    border-radius: 5px;\n    background-color: white;\n    box-shadow: 0 0 10px darkgray;\n}\n\n.title, .description {\n    display: flex;\n    flex-direction: column;\n    width: 90%;\n}\n\nfieldset {\n    text-align: center;\n}\n\n.todoSubmit {\n    padding: 8px 14px 8px 14px;\n    border-radius: 3px;\n}\n\nbutton {\n    background-color: white;\n}\n\nbutton:hover {\n    background-color: rgb(138, 138, 194);\n    color: white;\n}\n\n#active {\n    background-color: rgb(138, 138, 194);\n    color: white;\n    padding-right: 30px;\n}\n\n.iconGithub {\n    width: 40px;\n    align-self: center;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,iBAAiB;IACjB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,iBAAiB;IACjB,SAAS;AACb;;AAEA;IACI,qBAAqB;IACrB,UAAU;IACV,gBAAgB;AACpB;;AAEA;IACI,kBAAkB;IAClB,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,8BAA8B;IAC9B,eAAe;AACnB;;AAEA;IACI,gBAAgB;IAChB,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,qBAAqB;IACrB,SAAS;AACb;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;AACrB;;AAEA;IACI,UAAU;AACd;;AAEA;IACI,oCAAoC;IACpC,aAAa;IACb,4BAA4B;IAC5B,+BAA+B;AACnC;;AAEA;IACI,WAAW;IACX,oCAAoC;IACpC,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,6BAA6B;IAC7B,aAAa;IACb,WAAW;AACf;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,YAAY;IACZ,YAAY;IACZ,oCAAoC;IACpC,uBAAuB;IACvB,mBAAmB;IACnB,wCAAwC;AAC5C;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;AACvB;;AAEA;IACI,aAAa;IACb,SAAS;IACT,iBAAiB;AACrB;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;AACtB;AACA;IACI,kCAAkC;AACtC;;AAEA;IACI,4BAA4B;IAC5B,+BAA+B;AACnC;;AAEA;IACI,mBAAmB;IACnB,sBAAsB;AAC1B;;AAEA;IACI,sBAAsB;IACtB,uBAAuB;IACvB,mBAAmB;IACnB,SAAS;IACT,aAAa;IACb,UAAU;IACV,kBAAkB;IAClB,uBAAuB;IACvB,6BAA6B;AACjC;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,UAAU;AACd;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,0BAA0B;IAC1B,kBAAkB;AACtB;;AAEA;IACI,uBAAuB;AAC3B;;AAEA;IACI,oCAAoC;IACpC,YAAY;AAChB;;AAEA;IACI,oCAAoC;IACpC,YAAY;IACZ,mBAAmB;AACvB;;AAEA;IACI,WAAW;IACX,kBAAkB;AACtB","sourcesContent":["html {\n    min-height: 100vh;\n    margin: 0;\n}\n\nbody {\n    display: flex;\n    flex-direction: row;\n    min-height: 100vh;\n    margin: 0;\n}\n\n.sidebar {\n    padding: 20px 0 0 5px;\n    width: 10%;\n    min-width: 120px;\n}\n\nh1 {\n    text-align: center;\n    margin-top: 0;\n    padding-right: 5px;\n}\n\nh2, h3, h4, h5 {\n    margin: 0;\n}\n\n.panel {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    min-height: 90%;\n}\n\n#addCategory {\n    margin-top: 20px;\n    float: right;\n}\n\n#categories {\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n    gap: 20px;\n}\n\n#categoryForm {\n    margin-top: 20px;\n    text-align: right;\n}\n\n#categoryForm > input {\n    width: 50%;\n}\n\n.category {\n    border: 2px solid rgb(138, 138, 194);\n    padding: 10px;\n    border-top-left-radius: 10px;\n    border-bottom-left-radius: 10px;\n}\n\n#main {\n    width: 100%;\n    background-color: rgb(243, 243, 243);\n    display: flex;\n    flex-direction: column;    \n    align-items: center;\n}\n\n.listTitle {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-around;\n    padding: 20px;\n    width: 100%;\n}\n\n#list {\n    width: 100%;\n}\n\n.todo {\n    padding: 5px;\n    margin: 15px;\n    border: 1px solid rgb(138, 138, 194);\n    background-color: white;\n    border-radius: 10px;\n    box-shadow: 0 3px 3px rgb(138, 138, 194);\n}\n\n.todoHead {\n    display: flex;\n    flex-direction: row;\n    justify-content: space-between;\n}\n\n.expanded {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n}\n\n.expandButtons {\n    display: flex;\n    gap: 10px;\n    margin-left: 20px;\n}\n\n.edit, .delete {\n    border-radius: 5px;\n}\n\n#addTodo, #addCategory  {\n    font-size: x-large;\n}\n#addTodo:hover, #addCategory:hover  {\n    background-color: rgb(98, 146, 98);\n}\n\n#addCategory {\n    border-top-left-radius: 10px;\n    border-bottom-left-radius: 10px;\n}\n\n#addTodo {\n    border-radius: 15px;\n    padding: 0 10px 0 10px;\n}\n\n#todoForm {\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n    gap: 10px;\n    padding: 10px;\n    width: 60%;\n    border-radius: 5px;\n    background-color: white;\n    box-shadow: 0 0 10px darkgray;\n}\n\n.title, .description {\n    display: flex;\n    flex-direction: column;\n    width: 90%;\n}\n\nfieldset {\n    text-align: center;\n}\n\n.todoSubmit {\n    padding: 8px 14px 8px 14px;\n    border-radius: 3px;\n}\n\nbutton {\n    background-color: white;\n}\n\nbutton:hover {\n    background-color: rgb(138, 138, 194);\n    color: white;\n}\n\n#active {\n    background-color: rgb(138, 138, 194);\n    color: white;\n    padding-right: 30px;\n}\n\n.iconGithub {\n    width: 40px;\n    align-self: center;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony export */   "listDisplay": () => (/* binding */ listDisplay)
/* harmony export */ });
...
const formatDate = (date) => (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(date), 'dd/MM/yyyy');
...
const addHome = () => {
  if (categories.length === 0) {
    const home = new _category__WEBPACK_IMPORTED_MODULE_1__["default"]('Home');
    categories.push(home);
    (0,_display_controller__WEBPACK_IMPORTED_MODULE_3__.createHome)(home);
    localStorage.setItem('categories', JSON.stringify(categories));
  }
};

// Set up initial conditions for first/ fresh load of the page
categories.forEach((category) => (0,_display_controller__WEBPACK_IMPORTED_MODULE_3__.displayCategory)(category));
addHome();
(0,_display_controller__WEBPACK_IMPORTED_MODULE_3__.listDisplay)(activeCategory);
document.getElementById('currentCategory').innerHTML = activeCategory.title;
styleCategory();
...
const createCategory = (formValue) => {
  ...
  if (formValue.title.value === '' && categories.some((cat) => cat.edit === true)) {
    ...
    // Create new category
    const category = new _category__WEBPACK_IMPORTED_MODULE_1__["default"](
      formValue.title.value,
    );
    ...
    (0,_display_controller__WEBPACK_IMPORTED_MODULE_3__.displayCategory)(category);
  }
